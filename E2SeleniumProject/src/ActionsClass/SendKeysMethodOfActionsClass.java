...
public class SendKeysMethodOfActionsClass {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//act.moveToElement(emailTB).sendKeys("aniket@gmail.com").perform();
		act.sendKeys(emailTB,"aniket@gmail.com" ).perform();
		Thread.sleep(1000);
		
		//Sending input to Password Textfield using sendkeys() of Actions Class
		//act.moveToElement(passwordTB).click().sendKeys("quarty@12").perform();
		act.sendKeys(passwordTB,"quarty@12" ).perform();
		Thread.sleep(1000);
